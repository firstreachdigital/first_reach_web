...
export default function RemovalDetailPage() {
  ...
  const data = removalDetails[slug];
    ...
    <main className={styles.page}>
      ...
      {data.benefits && (
        <div className={styles.benefitsBlock}>
          <h3 className={styles.sectionHeading}>Why Choose This Service?</h3>
      ...
      <div className={styles.ctaBlock}>
        ...
        <Link to="/contact" className={styles.ctaBtn}>Contact Today <FaArrowRight /></Link>
      </div>
    </main>
  );
}